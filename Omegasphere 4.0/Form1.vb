Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If Dir(dossier, FileAttribute.Normal) <> "" Then
            Kill(dossier)
        End If
        My.Computer.Network.DownloadFile("https://fprogeek.yj.fr/omegasphere/Mise%20a%20jour.txt?=" & Rnd(402), dossier)
        ...
        If contenu <> Application.ProductVersion Then
            ...
            MsgBox("Une fois le fichier de mise a jour télechargé et installé, relancer OmegaSphere.", MsgBoxStyle.Information, Process.Start("https://github.com/FproGeek/omegasphere/releases/tag/4.0.3"))
        Else
